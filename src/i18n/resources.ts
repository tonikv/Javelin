...
export const resources: Record<Locale, Messages> = {
    ...
    'javelin.speedPassiveHint.rookie': 'Vauhti hiipuu tähtäyksessä - vapauta vihreällä alueella.',
    'javelin.speedPassiveHint.pro': 'Pro: vauhti hiipuu nopeammin ja vapautusikkuna on kapeampi.',
    'javelin.speedPassiveHint.elite': 'Elite: pidä naputusrytmi ja osuma hyvin kapeaan vapautusikkunaan.',
    ...
    'difficulty.hint.rookie': 'Perusikkuna ja anteeksiantava rytmi.',
    'difficulty.hint.pro': 'Tiukempi ajoitus: vauhti hiipuu nopeammin ja release-ikkuna pienenee.',
    'difficulty.hint.elite': 'Rytmi ratkaisee: osuvat naputukset pitävät vauhdin yllä.',
  ...
  sv: {
    ...
    'javelin.speedPassiveHint.rookie': 'Farten avtar under laddning - släpp i gröna zonen.',
    'javelin.speedPassiveHint.pro': 'Pro: farten avtar snabbare och släppfönstret är smalare.',
    'javelin.speedPassiveHint.elite': 'Elite: håll rytmen i ansatsen och släpp i ett mycket smalt fönster.',
    ...
    'difficulty.pro': 'Pro',
    'difficulty.elite': 'Elite',
    'difficulty.hint.rookie': 'Förlåtande timing och större släppfönster.',
    'difficulty.hint.pro': 'Stramare timing: snabbare farttapp och smalare släppfönster.',
    'difficulty.hint.elite': 'Rytmkrav: träffa rätt takt för att bygga fart.',
  ...
  en: {
    ...
    'javelin.speedPassiveHint.rookie': 'Speed decays during charge - release in the green zone.',
    'javelin.speedPassiveHint.pro': 'Pro: speed decays faster and the launch window is tighter.',
    'javelin.speedPassiveHint.elite': 'Elite: keep a steady tap rhythm and hit a very tight launch window.',
    ...
    'difficulty.pro': 'Pro',
    'difficulty.elite': 'Elite',
    'difficulty.hint.rookie': 'Forgiving timing with a wider release window.',
    'difficulty.hint.pro': 'Stricter timing: faster decay and tighter release window.',
    'difficulty.hint.elite': 'Rhythm-based run-up with the strictest release window.',
