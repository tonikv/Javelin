...
export const resources: Record<Locale, Messages> = {
    ...
    'javelin.speedPassiveHint.pro': 'Pro: sama keskisweep, mutta sweet spot on yhä Eliteä leveämpi.',
    'javelin.speedPassiveHint.elite': 'Elite: kiihdytä rytmiä keskikaistalla ja vapauta keskellä snap-ikkunaa.',
    ...
    'difficulty.hint.pro': 'Pro: sama sweep-nopeus, mutta sweet spot on selvästi Eliteä leveämpi.',
    'difficulty.hint.elite': 'Elite: rakenna vauhti rytmiin osumalla ja vapauta keskitettyyn snap-ikkunaan.',
    ...
    'scoreboard.globalSubmitDisabledDev': 'Globaali tallennus on estetty dev-tilassa (vain paikallinen tallennus).',
  ...
  sv: {
    ...
    'javelin.speedPassiveHint.pro': 'Pro: samma mittsvep, men sweet spoten är fortfarande bredare än i Elite.',
    'javelin.speedPassiveHint.elite': 'Elite: bygg fart genom att träffa mittenrytmen och släpp i mittenfönstret.',
    ...
    'difficulty.pro': 'Pro',
    'difficulty.elite': 'Elite',
    'difficulty.hint.rookie': 'Samma svephastighet, bredast mittfönster och mest förlåtande känsla.',
    'difficulty.hint.pro': 'Pro: samma svephastighet, men sweet spoten är tydligt bredare än i Elite.',
    'difficulty.hint.elite': 'Elite: bygg fart med rätt rytm och släpp i ett centrerat snap-fönster.',
    ...
    'scoreboard.globalSubmitDisabledDev': 'Global sparning är blockerad i dev-läge (endast lokal sparning).',
    'devAdmin.title': 'Dev Admin',
  ...
  en: {
    ...
    'javelin.speedPassiveHint.rookie': 'Rookie: release on the center lane, with the widest sweet spot.',
    'javelin.speedPassiveHint.pro': 'Pro: same center sweep, but the sweet spot is still wider than elite.',
    'javelin.speedPassiveHint.elite': 'Elite: build speed by matching the rhythm, then release on the center snap window.',
    ...
    'difficulty.hint.pro': 'Pro: same sweep speed, but the sweet spot is clearly wider than elite.',
    'difficulty.hint.elite': 'Elite: build speed by matching the rhythm, then release on the center snap window.',
    ...
    'scoreboard.globalSubmitDisabledDev': 'Global submit is disabled in dev mode (local save only).',
    'devAdmin.title': 'Dev Admin',
