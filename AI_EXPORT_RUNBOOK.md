...
Generated: 2026-02-21T20:34:33.578938+00:00
Total files: 54 | Runbook tokens: ~2,592
...
- `src/features/javelin/game/render.ts` (17 changes)
- `src/features/javelin/game/update.ts` (17 changes)
- `src/features/javelin/game/reducer.test.ts` (14 changes)
- `src/features/javelin/game/types.ts` (13 changes)
...
- `src/features/javelin/hooks/usePointerControls.ts` (7 changes)
- `src/features/javelin/game/selectors.ts` (7 changes)
- `src/features/javelin/components/HudPanel.tsx` (6 changes)
- `src/features/javelin/game/tuning.ts` (6 changes)
- `public/locales/en/common.json` (5 changes)
- `public/locales/fi/common.json` (5 changes)
- `public/locales/sv/common.json` (5 changes)
- `src/features/javelin/JavelinPage.tsx` (5 changes)
...
- `src/features/javelin/game/render.ts` → ./athletePose, ./audio, ./camera, ./constants, ./renderAthlete, ./renderMeter, ./selectors, ./tuning, ./types
...
- `src/features/javelin/hooks/usePointerControls.ts` → ../game/audio, ../game/controls, ../game/render, ../game/types
...
- `src/features/javelin/game/render.ts` (601 lines) — getVisibleJavelinRenderState, getPlayerAngleAnchorScreen, renderGame

### Audio
- `src/features/javelin/game/audio.ts` (60 lines) — playBeatTick, resumeAudioContext

### Frontend / UI
- `src/features/javelin/components/CircularTimingMeter.tsx` (101 lines) — CircularTimingMeter
- `src/features/javelin/components/ControlHelp.tsx` (40 lines) — ControlHelp
- `src/features/javelin/components/GameCanvas.tsx` (76 lines) — GameCanvas
...
### Other code & helpers
- `src/features/javelin/game/types.ts` (163 lines) — Locale, FaultReason, TimingQuality, MeterWindow, RhythmState, ChargeMeterState, AthletePoseState, ThrowInput, LaunchSnapshot, PhysicalJavelinState (+5 more)
- `.github/copilot-instructions.md` (6 lines)
- `.github/workflows/deploy.yml` (41 lines)
- `agent-guide-gameplay-v2.md` (868 lines)
- `AGENTS.md` (26 lines)
...
- `src/features/javelin/game/update.ts` (705 lines) — createInitialGameState, reduceGameState
...
- `src/features/javelin/hooks/usePointerControls.ts` (182 lines) — usePointerControls
- `src/features/javelin/JavelinPage.tsx` (181 lines) — JavelinPage
- `src/i18n/init.tsx` (73 lines) — I18nProvider, useI18n
- `src/i18n/resources.ts` (190 lines) — Messages, resources
- `src/index.css` (406 lines)
...
- `src/features/javelin/game/reducer.test.ts` (326 lines)
- `src/features/javelin/game/render.test.ts` (203 lines)
- `src/features/javelin/game/scoring.test.ts` (85 lines)
- `src/features/javelin/game/selectors.test.ts` (43 lines)
